...
<html lang="en">
  <head>
    ...
    <title>Visite de grocesse</title>
  </head>
  <body>
      ...
      <div class="row align-items-stretch justify-content-center no-gutters">
        <div class="col-md-7">
          <div class="form h-100 contact-wrap p-5">
            ...
            <form action="{{url('/infermiere/VisiteGrocesse')}}" method="POST" enctype="multipart/form-data">
              @csrf                               
              <div class="row">
          ...
          <div class="col-md-6 form-group mb-3">
              ...
              <div class="row">
                ...
                <div class="col-md-6 form-group mb-3">
                  <label for="" class="col-form-label">Début de grocesse</label>
                  <input type="date" class="form-control" name="debutdegrocesse" id="email"  placeholder="Date de visite reprise cas spécifique">
                </div>
                <div class="col-md-6 form-group mb-3">
                  <label for="" class="col-form-label">Fin de grocesse</label>
                  <input type="date" class="form-control" name="findegrocesse" id="email"  placeholder="Motif">
                </div>
                
              </div>
              <div class="row">
                 <div class="col-md-6 form-group mb-3">
                  <label for="" class="col-form-label">Date prevu de la premiere visite</label>
                  <input type="date" class="form-control" name="dateprevudelaprmierevisite" id="name"  placeholder="Date prevu de la premiere visite">
                </div>
              </div>
              <div class="row mb-5">
              <div class="col-md-12 form-group mb-3">
                <label for="message" class="col-form-label">Remarque Medecin pendant la 1e visite</label>
                <textarea class="form-control" name="remarquemedecinpremierevisite" id="message" cols="30" rows="4"  ></textarea>
              </div>
            </div>
              ...
              <div class="row">
                ...
                <div class="col-md-6 form-group mb-3">
                  <label for="" class="col-form-label">Date prévu de la deuxième visite</label>
                  <input type="date" class="form-control" name="dateprevude2evisite" id="email"  placeholder="Motif">
                </div>
                
              </div>
              <div class="row mb-5">
                <div class="col-md-12 form-group mb-3">
                  <label for="message" class="col-form-label">Remarque Medecin pendant la 2e visite</label>
                  <textarea class="form-control" name="remarquemedecin2evisite" id="message" cols="30" rows="4"  ></textarea>
                </div>
              </div>

...
<html lang="en">
  <head>
    ...
    <title>Visite d'audiogrammme</title>
  </head>
  <body>
      ...
      <div class="row align-items-stretch justify-content-center no-gutters">
        <div class="col-md-7">
          <div class="form h-100 contact-wrap p-5">
            ...
            <form action="{{url('/infermiere/VisiteAudiogramme')}}" method="POST" enctype="multipart/form-data">
              @csrf                       <div class="row">
          ...
          <div class="col-md-6 form-group mb-3">
            ...
            <div class="row">
              ...
              <div class="row">
                ...
                <div class="col-md-6 form-group mb-3">
                  <label for="" class="col-form-label">Date intiale audio</label>
                  <input type="date" class="form-control" name="dateinitialaudio" id="email"  placeholder="Date intiale audio">
                </div>
                <div class="col-md-6 form-group mb-3">
                    <label for="" class="col-form-label">Date après 6 mois</label>
                    <input type="date" class="form-control" name="dateapres6mois" id="email"  placeholder="Date après 6 mois">
                  </div>
                ...
                <div class="row mb-5">
                  <div class="col-md-12 form-group mb-3">
                    ...
                    <textarea class="form-control" name="remarquemedecin0" id="message" cols="30" rows="4"  ></textarea>
                  </div>
                </div>

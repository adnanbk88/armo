      ...
      <div class="row align-items-stretch justify-content-center no-gutters">
        <div class="col-md-7">
          <div class="form h-100 contact-wrap p-5">
            ...
            <form action="{{url('/infermiere/VisiteSpantane')}}" method="POST" enctype="multipart/form-data">
              @csrf              
              <div class="row">
          ...
          <div class="col-md-6 form-group mb-3">
              ...
              <div class="row">
                ...
                <div class="col-md-6 form-group mb-3">
                  <label for="" class="col-form-label">Date de visite spantannée</label>
                  <input type="date" class="form-control" name="datevisitespantanée" id="email"  placeholder="Radio 2021">
                </div>
              
              <div class="col-md-6 form-group mb-3">
                <label for="" class="col-form-label">Motif</label>
                <input type="text" class="form-control" name="motif" id="email"  placeholder="Motif">
              </div>
              </div>
              ...
              <div class="row mb-5">
                <div class="col-md-12 form-group mb-3">
                  ...
                  <textarea class="form-control" name="remarquemedecin1" id="message" cols="30" rows="4"  ></textarea>
                </div>
              </div>

      ...
      <div class="row align-items-stretch justify-content-center no-gutters">
        <div class="col-md-7">
          <div class="form h-100 contact-wrap p-5">
            ...
            <form action="{{url('/infermiere/VisitePeriodique')}}" method="POST" enctype="multipart/form-data">
              @csrf                 <div class="row">
          ...
          <div class="col-md-6 form-group mb-3">
              ...
              <div class="row">
                <div class="col-md-6 form-group mb-3">
                  ...
                  <input type="date" class="form-control" name="radio2021" id="name"  placeholder="Radio chaque 2 ans">
                </div>
                <div class="col-md-6 form-group mb-3">
                  <label for="" class="col-form-label">Visite 2021</label>
                  <input type="date" class="form-control" name="visite2021" id="email"  placeholder="Your email">
                </div>
              </div>
              <div class="row">
                <div class="col-md-6 form-group mb-3">
                  <label for="" class="col-form-label">Audio 2021 </label>
                  <select class="form-control" name="audio2021" id="pet-select">
                    <option value="">--Veuillez choisissez--</option>
                    <option value="OUI">OUI</option>
                    <option value="NON">NON</option>
                </select>                </div>
                <div class="col-md-6 form-group mb-3">
                  <label for="" class="col-form-label">Aptitude phusique</label>
                  <label for="message" class="col-form-label">Aptitude physique</label>

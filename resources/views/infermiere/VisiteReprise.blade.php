      ...
      <div class="row align-items-stretch justify-content-center no-gutters">
        <div class="col-md-7">
          <div class="form h-100 contact-wrap p-5">
            ...
            <form action="{{url('/infermiere/VisiteReprise')}}" method="POST" enctype="multipart/form-data">
              @csrf              <div class="row">
          ...
          <div class="col-md-6 form-group mb-3">
              ...
              <div class="row">
                ...
                <div class="col-md-6 form-group mb-3">
                  <label for="" class="col-form-label">Date de visite reprise cas spécifique</label>
                  <input type="date" class="form-control" name="datevisitecasspecifique" id="email"  placeholder="Date de visite reprise cas spécifique">
                </div>
                
                <div class="col-md-6 form-group mb-3">
                  <label for="" class="col-form-label">Nature de la maladie</label>
                  <input type="text" class="form-control" name="naturedemaladie" id="email"  placeholder="nature de la maladie">
                </div>
              </div>
              <div class="row">
                
                <div class="col-md-6 form-group mb-3">
                  <label for="" class="col-form-label">Motif</label>
                  
<select class="form-control" name="motifdevisite" id="pet-select">
  <option value="">--Veuillez choisissez--</option>
  <option value="absence répétée">Absence répétée</option>
  <option value="Accident circulation">Accident circulation</option>
  <option value="Accident trajet">Accident trajet</option>
  <option value="Accident travail">Accident travail</option>
  ...
  <option value="Maternité">Maternité</option>
              ...
              <div class="row mb-5">
                <div class="col-md-12 form-group mb-3">
                  <label for="message" class="col-form-label">Remarque Medecin pendant la visite</label>
                  <textarea class="form-control" name="remarquemedecinpendantlavisite" id="message" cols="30" rows="4"  ></textarea>
                </div>
              </div>

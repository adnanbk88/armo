...
<html lang="en">
  ...
  <body>
    <form action="{{url('/infermiere/AjouterEmploye')}}" method="POST" enctype="multipart/form-data">
@csrf
  <div class="content">
      ...
      <div class="row align-items-stretch justify-content-center no-gutters">
        <div class="col-md-7">
          <div class="form h-100 contact-wrap p-5">
            <h3 class="text-center">Ajouter un nouveau employé</h3>
            <form class="mb-5" method="post" id="contactForm" name="contactForm">
              ...
              <div class="row">
                <div class="col-md-6 form-group mb-3">
                  ...
                  <input type="text" class="form-control" name="prenom" id="name" placeholder="prenom">
                </div>
           
          <div class="col-md-6 form-group mb-3">
                  <label for="" class="col-form-label">CIN</label>
                  <input type="text" class="form-control" name="cin" id="email"  placeholder="CIN">
                </div>
              </div>
              <div class="row">
                <div class="col-md-6 form-group mb-3">
                  <label for="" class="col-form-label">Site:</label>
                  <select name="site" class="form-control" id="pet-select">
                ...
                <div class="col-md-6 form-group mb-3">
                  ...
                  <select name="sex" class="form-control" id="pet-select">
                    <option value="">veuillez choisissez</option>
              ...
              <div class="row">
                <div class="col-md-6 form-group mb-3">
                  ...
                  <input type="text" class="form-control" name="cnss" id="name" placeholder="CNSS">
                </div>
             <div class="col-md-6 form-group mb-3">
                  <label for="" class="col-form-label">Date de naissance</label>
                  <input type="date" class="form-control" name="datedenaissance" id="name" placeholder="date de naissance">
                </div> </div>
              <div class="row">
                
                 <div class="col-md-6 form-group mb-3">
                  <label for="" class="col-form-label">Date d'ambauche</label>
                  <input type="date" class="form-control" name="datedeambauche" id="email"  placeholder="date d'ambauche">
                </div>
              
             <div class="col-md-6 form-group mb-3">
                  <label for="" class="col-form-label">Date de sortie</label>
                  <input type="date" class="form-control" name="datedesortie" id="name" placeholder="date de sortie">
                </div>
            </div>
              <div class="row">
                 ...
                 <div class="col-md-6 form-group mb-3">
                  ...
                  <select name="service" class="form-control" id="pet-select">
                    <option  value="">--Veuillez choisissez--</option>
             ...
             <div class="col-md-6 form-group mb-3">
                  ...
                  <select name="section" class="form-control" name="pets" id="pet-select">
                    <option value="">--Veuillez choisissez--</option>
